...
- Streaming process details use a compact summary and an expandable timeline. Commands, stderr, and exit codes stay in a secondary runtime-details disclosure. Codex shows **当前轮** and **累计** from protocol counts as soon as they arrive; Grok shows **当前轮** only. Numbers stay on the reply header and the generating summary. No fake usage bar.
...
- Streaming process panel with expandable timeline; Codex 当前轮 + 累计 and Grok 当前轮 on the reply header; copy for completed messages only.
