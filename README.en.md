...
**MCP** scans MCP found on this machine and can probe then write into Claude / Codex / Grok / Cursor / WorkBuddy. **Plugins** lists packs already installed in Claude, Grok, and Pi. Claude and Grok packs can be installed, uninstalled, enabled, or disabled here. Pi remains list-only.
...
- **MCP**: scan plus write/enable for Claude / Codex / Grok / Cursor / WorkBuddy; other agents and OAuth are still out of scope.
