...
use crate::services::adapter_route_constants::{
    ...
    DEEPSEEK_CODEX_DEFAULT_MODEL, DEEPSEEK_CODEX_PROVIDER_PREFIX, DEEPSEEK_CODEX_PROVIDER_SLUG,
    DEEPSEEK_CODEX_RULE_ID, DEEPSEEK_PI_PROVIDER_SLOT, DEEPSEEK_PI_RULE_ID, DSH_API_KEY_ENV,
    DSH_DEEPSEEK_PROVIDER_SLOT, DSH_DEFAULT_MODEL, GLM_CLAUDE_DEFAULT_MODEL, GLM_CLAUDE_RULE_ID,
