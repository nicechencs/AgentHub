  ...
  if (step.type === 'tool') {
    ...
    return (
      <div className="py-1">
        ...
        {input ? (
          <pre className="mt-0.5 max-h-16 overflow-auto whitespace-pre-wrap break-all font-mono text-2xs text-muted">
            {input}
          </pre>
        ) : null}
        {step.result ? (
          <DiffAwarePre
            text={step.result}
            className="mt-1 max-h-28 overflow-auto font-mono text-2xs leading-relaxed text-secondary"
          />
        ) : null}
      </div>
    );
            ...
            <div className="mt-1.5 space-y-2">
              {view.command ? (
                <div>
                  ...
                  <pre className="max-h-24 overflow-auto whitespace-pre-wrap break-all rounded-btn bg-subtle px-2 py-1.5 font-mono text-2xs leading-relaxed text-primary">
                    {view.command}
                  </pre>
                </div>
              ) : null}
              {view.stderr ? (
                <div>
                  ...
                  <pre className="max-h-36 overflow-auto whitespace-pre-wrap break-all rounded-btn bg-subtle px-2 py-1.5 font-mono text-2xs leading-relaxed text-danger/90">
                    {view.stderr}
                  </pre>
                </div>
              ) : null}
