...
归档时的 `src/pages/bridges/index.tsx` 页面注释已经写明：这是 **local-bridge runtime ops page**。当前代码已将入口拆分到 [`src/App.tsx`](../../src/App.tsx) 和 `src/pages/routes/*`，运行时列表组件为 [`src/pages/bridges/AdapterProfilesList.tsx`](../../src/pages/routes/shared/AdapterProfilesList.tsx)。以下职责结论仍是本审计快照当日的历史记录，不替代当前实现契约。它主要负责：
...
| 主题 | 证据 |
|---|---|
| 页面三端点、目标映射 | [`src/lib/route-endpoints.ts`](../../src/lib/route-endpoints.ts)、[`src/pages/bridges/create-route-flow.ts`](../../src/pages/routes/shared/create-route-flow.ts) |
| `/routes` 职责 | [`src/App.tsx`](../../src/App.tsx)、[`AdapterProfilesList.tsx`](../../src/pages/routes/shared/AdapterProfilesList.tsx)、[`adapters-and-bridges.md`](../concepts/adapters-and-bridges.md) |
